...
ENV REACT_APP_CHAT_ROLE_MAPS='{"block-chat": {"sendTo": [], "placeholder": "You have been blocked from Chat"}, "hls-viewer": {"sendTo": ["teacher", "admin"],"placeholder": "Send a message to the teacher"},"student-on-stage": {"sendTo": ["teacher", "admin"],"placeholder": "Send a message to the teacher"}}'
